...
public class TETile {
    ...
    /**
     * Returns {@code true} if the two {@code TETiles}
     * has the same {@code character} representation.
     *
     * @param obj Other {@code Object} to compare to.
     * @return {@code true} only if {@code obj} is also
     * a {@code TETile} and has the same {@code character}
     * as {@code this}.
     */
    @Override
